package com.example.springbootrestswagger.endpoint;
...
import com.example.springbootrestswagger.service.PersonService;
...
//        Pageable pageable = new PageRequest(page, size, Sort.by("id"));
	...
	return (!person.isPresent() ? ResponseEntity.status(HttpStatus.NOT_FOUND) : ResponseEntity.ok())
		.body(person.get());
    }
