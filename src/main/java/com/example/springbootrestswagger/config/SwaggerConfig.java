package com.example.springbootrestswagger.config;
...
//                .apis(RequestHandlerSelectors.any())
		.apis(RequestHandlerSelectors.basePackage("com.example.springbootrestswagger"))
		.paths(PathSelectors.regex("/v1/.*")).build().apiInfo(apiInfo());
    }

    private ApiInfo apiInfo() {
	ApiInfo apiInfo = new ApiInfo("PersonSearchApplication",
		"An application to search Person from a Person repository by personId",
		"PersonSearchApplication v1",
		"Terms of service",
		"{com.example.springbootrestswagger}@{example.com}",
		"License of API",
